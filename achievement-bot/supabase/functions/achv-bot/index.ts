...
const SAVED = ['Записала ✨', 'Сохранила 🌱', 'Есть, записала 💛', 'Зафиксировала ✨',
  'Поймала момент 📌', 'Отложила в копилку 🫙', 'Легло в дневник 📖', 'Ага, записала ✨',
  'Держу 💛', 'Добавила 🌱', 'Записано ✨', 'В копилку 🌿', 'Готово, сохранила 🌙',
  'Есть такое 💛', 'Приняла ✨', 'Пусть будет 🌱'];
