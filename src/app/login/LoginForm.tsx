  ...
  return (
    <div
      style={{
        ...
        padding:
          "max(28px, calc(env(safe-area-inset-top) + 18px)) 22px max(24px, calc(env(safe-area-inset-bottom) + 18px))",
      }}
    >
      <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center", maxWidth: 380, width: "100%", margin: "0 auto" }}>
        ...
        >
          {mode === "signin"
            ? "Задачи и привычки в одном месте."
            : "Сферы, задачи, привычки — синхронизация на все устройства."}
        </p>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10, margin: "4px 0 18px" }}>
          ...
          <span style={{ fontSize: 12, color: "var(--ink-40)", letterSpacing: "0.02em" }}>или</span>
          <span style={{ flex: 1, height: 1, background: "var(--ink-10)" }} />
        </div>
